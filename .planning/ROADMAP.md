...
<!-- PR-IMPROVE:1007 --> - PR #1007: fix: resolve #995 - MNT-E03: Automation KPI digest (maintenance) -- pr1007.2 x1, pr1007.4 x1. Quick artifact: `.planning/quick/260807-pr1007-workflow-improve/260807-pr1007-PLAN.md`.
<!-- PR-IMPROVE:1014 --> - PR #1014: fix: resolve #998 - WHO-E03: Queue-latency telemetry and starvation alerts (workflow-health-optimize) -- pr1014.1 x1, pr1014.2 x1. Quick artifact: `.planning/quick/260808-pr1014-workflow-improve/260808-pr1014-PLAN.md`.
<!-- PR-IMPROVE:1019 --> - PR #1019: fix: resolve #1017 - APR-E10: Escalate twice-recommended systemic fixes to issues (audit-auto-prs) -- pr1019.2 x2. Quick artifact: `.planning/quick/260808-pr1019-workflow-improve/260808-pr1019-PLAN.md`.
<!-- PR-IMPROVE:1026 --> - PR #1026: fix: resolve #1023 - MNT-E08: Runner health self-check (maintenance) -- pr1026.2 x1, pr1026.4 x1. Quick artifact: `.planning/quick/260807-pr1026-workflow-improve/260807-pr1026-PLAN.md`.
<!-- PR-IMPROVE:1033 --> - PR #1033: fix: resolve #1031 - MNT-I08: Clarify stale-issue boundaries vs stale.yml and issue-catch-up (maintenance) -- pr1033.1 x1, pr1033.2 x1. Quick artifact: `.planning/quick/260809-pr1033-workflow-improve/260809-pr1033-PLAN.md`.
<!-- PR-IMPROVE:1052 --> - PR #1052: fix: resolve #1050 - APR-I07: Pass '--title-prefix' to duplicate detection (audit-auto-prs) -- pr1052.2 x1. Quick artifact: `.planning/quick/260808-pr1052-workflow-improve/260808-pr1052-PLAN.md`.
<!-- PR-IMPROVE:1076 --> - PR #1076: fix: resolve #1071 - MNT-I09: Trim allowed-tools to the sweep's needs (maintenance) -- pr1076.1 x1. Quick artifact: `.planning/quick/260809-pr1076-workflow-improve/260809-pr1076-PLAN.md`.
...
## Improvement Intake: Architectural Review Pass 17 (2026-08-07)

Source: `/gsd:explore` seventeenth-pass review (non-duplicative vs proposals #1-#46 and open PRs). Artifact: `.planning/quick/260807-arch-review-pass17/proposal.md`

| # | Proposal | Severity | Area | Status |
|---|----------|----------|------|--------|
| 47 | **Remove shell metacharacter guard from HTTP-bound config-applier values** — `validateNoInjection()` rejects values with ``;|&$`\\`` but the push path is purely HTTP (`httpClient` → JSON body). No shell involved. The guard rejects legitimate WireGuard endpoints containing `$` (hostnames interpolating shell variables), `&` (URLs), or `\` (paths). Injection safety is already provided by `execFile()` array args. Fix: remove `DANGEROUS_CHARS`, `validateNoInjection()`, and three calls at lines 131-136 | Medium (Correctness) | `src/lib/config-applier.ts:8-14, 131-136` | Proposed |
