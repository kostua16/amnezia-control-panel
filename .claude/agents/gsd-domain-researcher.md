...
<required_reading>
Read `/home/runner/_work/amnezia-control-panel/amnezia-control-panel/.claude/get-shit-done/references/ai-evals.md` — specifically the rubric design and domain expert sections.
</required_reading>
