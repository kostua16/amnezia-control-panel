...
<required_reading>
Read `/home/runner/_work/amnezia-control-panel/amnezia-control-panel/.claude/get-shit-done/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
