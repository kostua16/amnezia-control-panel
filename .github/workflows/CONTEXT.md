...
- **wake / prt** — pr-flow concurrency event classes: _wake_ = reactive (workflow_run / issue_comment / workflow_dispatch), _prt_ = `pull_request_target` orchestrate. See [[e2e-cancellation-cascade]].
